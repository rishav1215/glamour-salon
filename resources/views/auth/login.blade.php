...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-xl overflow-hidden">
        <!-- Decorative Header -->
        <div class="bg-gradient-to-r from-primary-600 to-primary-500 py-4 px-6">
            <div class="flex items-center justify-center space-x-2">
                <i class="fas fa-spa text-white text-2xl"></i>
                <span class="text-white text-xl font-bold">Glamour Salon</span>
            </div>
            <h2 class="text-white text-center text-2xl font-bold mt-2">Welcome Back</h2>
        </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('custom.login') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm text-primary-600 hover:text-primary-500 hover:underline">Forgot password?</a>
                </div>

                <button type="submit"
                        class="w-full bg-gradient-to-r from-primary-600 to-primary-500 text-white py-3 px-4 rounded-lg font-medium hover:from-primary-500 hover:to-primary-400 transition duration-300 shadow-md hover:shadow-lg">
                    Login
                </button>
            </form>
