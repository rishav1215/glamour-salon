...
@section('content')
    ...
    @foreach($salons as $salon)
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
            <div class="relative h-56 overflow-hidden">
                ...
                <span class="absolute top-3 right-3 bg-white/90 text-primary-600 text-xs font-semibold px-2 py-1 rounded-full">
                    OPEN NOW
                </span>
            </div>
            <div class="p-5">
    ...
    @if(Auth::user()->role === 'salon_owner')
        <div
            ...
            <p class="text-gray-600 mb-6">Manage your salon profile, services, and appointments all in one place.</p>
            <a href="{{ route('salon.create') }}"
